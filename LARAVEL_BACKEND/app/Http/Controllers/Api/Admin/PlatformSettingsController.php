...
class PlatformSettingsController extends Controller
{
    public function show(): JsonResponse
    {
        ...
        $out = [
            ...
            'defaultBillingModel' => $data['default_billing_model'] ?? 'subscription',
            'defaultCommissionRate' => isset($data['default_commission_rate']) ? (float) $data['default_commission_rate'] : 0.00,
            'allowPublicCommissionSignup' => (bool) ($data['allow_public_commission_signup'] ?? false),
            'defaultCommissionThreshold' => isset($data['default_commission_threshold']) ? (float) $data['default_commission_threshold'] : 50.00,
            'commissionGracePeriodDays' => isset($data['commission_grace_period_days']) ? (int) $data['commission_grace_period_days'] : 7,
    ...
    public function update(Request $request, AuditService $audit): JsonResponse
    {
        $validated = $request->validate([
            ...
            'defaultBillingModel' => 'sometimes|string|in:subscription,commission,hybrid',
            'defaultCommissionRate' => 'nullable|numeric|min:0|max:100',
            'allowPublicCommissionSignup' => 'sometimes|boolean',
            'defaultCommissionThreshold' => 'nullable|numeric|min:0',
            'commissionGracePeriodDays' => 'nullable|integer|min:0|max:365',
        ...
        $map = [
            ...
            'defaultBillingModel' => 'default_billing_model',
            'defaultCommissionRate' => 'default_commission_rate',
            'allowPublicCommissionSignup' => 'allow_public_commission_signup',
            'defaultCommissionThreshold' => 'default_commission_threshold',
            'commissionGracePeriodDays' => 'commission_grace_period_days',
            'aiModel' => 'ai_model',
