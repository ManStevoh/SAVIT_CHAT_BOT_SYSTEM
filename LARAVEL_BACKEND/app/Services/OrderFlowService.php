...
class OrderFlowService
{
    ...
    protected function wantsCatalogList(string $lower, string $trimmed): bool
    {
        ...
        return (bool) preg_match('/\b(?:catalog|products|menu|(?:show|list|see|view)\s+items|what do you sell|show me your catalog|show me catalog|show catalog|view catalog|list products|see products|see catalog)\b/iu', $lower);
    }
