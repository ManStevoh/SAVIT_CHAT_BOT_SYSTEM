...
final class WhatsAppReplyRouter
{
    ...
    public function resolve(
        ...
        if ($this->modeResolver->isAiFirst($company)) {
            return $this->routeAiFirst($company, $message, $lower, $customerName, $chatId, $orderFlowContext);
        }

        return $this->routeBalanced($company, $message, $lower, $customerName, $chatId, $orderFlowContext);
    }

    /**
     * @return array{route: string, text: string, meta?: array<string, mixed>}
     */
    private function routeAiFirst(
        Company $company,
        string $message,
        string $lower,
        ?string $customerName,
     ...
     * @return array{route: string, text: string, meta?: array<string, mixed>}
     */
    private function routeBalanced(
        Company $company,
        string $message,
        string $lower,
        ?string $customerName,
