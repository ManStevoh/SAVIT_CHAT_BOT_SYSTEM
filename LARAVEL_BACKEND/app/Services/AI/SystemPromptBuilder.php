...
class SystemPromptBuilder
{
    ...
    public function build(
        ...
        $parts = array_merge($parts, [
            ...
            'CRITICAL - CATALOG REQUESTS: If the customer asks to see your catalog, menu, products, list of items, or says "show me your catalog", "products", "what do you sell", YOU MUST present the full product list from your catalog context with product numbers (1., 2., 3.), names, and prices, OR call process_order_message or get_catalog. Always offer a clear path to order.',
