...
use App\Http\Controllers\Api\Company\EventController;
...
Route::prefix('company')->middleware(['auth:sanctum', 'user.active', 'subscription.active'])->group(function () {
    ...
    Route::post('events/{event}/ticket-types', [EventController::class, 'storeTicketType']);
    Route::put('events/{event}/ticket-types/{ticketType}', [EventController::class, 'updateTicketType']);
    Route::delete('events/{event}/ticket-types/{ticketType}', [EventController::class, 'destroyTicketType']);
    Route::get('events/{event}/registrations', [EventController::class, 'registrations']);
    Route::post('events/{event}/registrations/{registration}/cancel', [EventController::class, 'cancelRegistration']);
    Route::get('events/{event}/tickets/lookup', [EventController::class, 'lookupTicket']);
    Route::post('events/{event}/attendees/{attendee}/check-in', [EventController::class, 'checkIn']);
