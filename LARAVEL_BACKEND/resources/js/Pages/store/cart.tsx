                  ...
                  >
                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-xs text-slate-500 dark:text-slate-400">{formatPrice(item.price, company.currency)} each</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <p className="text-xs font-extrabold text-slate-900 dark:text-white">{formatPrice(item.lineTotal, company.currency)}</p>
                      </div>
              ...
              <div className="sticky top-20 space-y-5 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xl shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900 dark:shadow-none">
                ...
                <div className="space-y-2.5 text-xs">
                  <div className="flex justify-between text-slate-600 dark:text-slate-400">
                    <span>Subtotal</span>
                    <span className="font-semibold text-slate-800 dark:text-slate-200">{formatPrice(cart.subtotal, company.currency)}</span>
                  </div>

                  {cart.taxTotal > 0 && (
                    <div className="flex justify-between text-slate-600 dark:text-slate-400">
                      <span>Estimated Tax</span>
                      <span className="font-semibold text-slate-800 dark:text-slate-200">{formatPrice(cart.taxTotal, company.currency)}</span>
                    </div>
                  )}
                  ...
                  <div className="flex items-baseline justify-between border-t border-slate-200/80 pt-3 text-base font-extrabold text-slate-900 dark:border-slate-700 dark:text-white">
                    ...
                    <span className="text-xl text-emerald-600 dark:text-emerald-400">{formatPrice(cart.total, company.currency)}</span>
                  </div>
                </div>
