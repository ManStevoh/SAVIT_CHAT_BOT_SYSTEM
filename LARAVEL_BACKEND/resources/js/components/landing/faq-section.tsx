...
const FALLBACK_FAQS = [
  ...
  { id: "6", question: "What's included in the free plan?", answer: "Starter is free forever: online storefront, bookings, dine-in (5 tables), and 20 products. No credit card required. Upgrade to Growth for WhatsApp and more." },
]
