...
const FALLBACK_FAQS = [
  ...
  { id: "6", question: "What's included in the free plan?", answer: "Starter is free forever: WhatsApp storefront, bookings, dine-in (5 tables), and 20 products. No credit card required. Upgrade to Growth when you need more." },
]
