      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 space-y-8">
          {items.map((item, index) => {
            ...
            return (
              <Reveal key={item.id ?? item.title} delayMs={index * 40}>
                <article
                  id={item.id}
                ...
                >
                  <div className={cn("grid gap-0 lg:grid-cols-2", reversed && "lg:[&>*:first-child]:order-2")}>
                    <div className="p-8 lg:p-10">
                      ...
                      <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary transition-colors">
                      ...
                      {item.ctaText && item.ctaHref && (
                        <Button
                          asChild
                          className="mt-8 h-11 gap-2 rounded-lg bg-primary px-6 text-white transition-transform hover:bg-primary/90 hover:-translate-y-0.5"
                        >
          ...
          {items.map((item, i) => {
            ...
            return (
              <Reveal key={item.title} delayMs={i * 60}>
                <div className="h-full rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-md lg:p-8">
        ...
        <div className="mt-12 grid gap-5 lg:grid-cols-3">
          {items.map((item, i) => (
            <Reveal key={item.title} delayMs={i * 70}>
              <article className="flex h-full flex-col rounded-2xl border border-border bg-card p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-md">
...
export function LandoOutcomes({
  ...
  return (
    <section id="outcomes" className="bg-muted py-12 lg:py-16">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="overflow-hidden rounded-3xl border border-border bg-card px-6 py-10 shadow-sm transition-shadow duration-300 hover:shadow-md sm:px-10 lg:px-12">
